...
public class Threading {
    ...
    * Unfortunately, this code doesn't work correctly. Try and fix it.
    ...
    * The class has a getter getResult() that returns the calculated sum or 0 if the
    * thread has not calculated the sum yet.
