...
public class CatchingExceptions {
    private static String array = null;
        ...
        * Consider the two methods: methodThrowingExceptions and methodCatchingSomeExceptions.
        ...
        Your task is to implement the second method. It must call the first
        method and catch two types of exceptions:

        ArrayIndexOutOfBoundsException
        NumberFormatException
        Inside the catch block (or blocks) you should print the name of the
        handled exception class (only name, without packages) to the standard output, like:
